...
public class LogSpiralPanel extends JPanel
{
   ...
   public void paintComponent(Graphics g)
   {
       ...
       Rectangle sqr=new Rectangle(0,0,sideLength,sideLength);
       Rectangle rect=new Rectangle(0,0,(int)(sideLength*GOLDEN_MEAN),sideLength);
       g2.draw(sqr);
       g2.draw(rect);
       recursiveDraw(g2,0,0,sideLength,90);
       /* Your code goes here.
   ...
   */
   ...
   {       
       ...
       else
       {
           ...
           recursiveDraw(g2,x,y,newSide,angle);
       }
   }
